<?php
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
        ...
        $stmt = $pdo->prepare('SELECT id, user_name, password FROM admins where user_name = :username and password = :password');
        $stmt->execute(array(
    ...
    // $student_list = $pdo->query('SELECT id, student_name, branch_name FROM students JOIN branches ON students.branch_id = branches.id');
?>
